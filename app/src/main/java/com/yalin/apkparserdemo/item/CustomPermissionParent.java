...
public class CustomPermissionParent extends ParentItem<PermissionInfo> {
    public CustomPermissionParent(List<PermissionInfo> children) {
        super(children);
    }
    ...
    public void bindParentView(View convertView) {
        ...
        parentName.setText("CustomPermission");
    }
