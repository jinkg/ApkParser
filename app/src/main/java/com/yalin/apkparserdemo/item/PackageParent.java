...
public class PackageParent extends ParentItem<Object> {
    private String mPackageName;

    public PackageParent(String packageName) {
        super(null);
    ...
    public void bindParentView(View convertView) {
        ...
        parentName.setText("PackageName");
    }
    ...
    public void bindChildView(int childPosition, View convertView) {
        ...
        childName.setText(mPackageName);
    }
